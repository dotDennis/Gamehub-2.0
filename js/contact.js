...
const API = "https://gamehub-api.dennisl.no/wp-json/contact-form-7/v1/contact-forms/54/feedback";
...
const formInputs = () => [form["fullName"], form["email"], form["message"]];
...
function validForm() {
  ...
  const isInputValidArr = [checkLength(fullName, 5), validateEmail(email), checkLength(message, 25)];
